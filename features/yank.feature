Feature: Delete Gems
  ...
  Scenario: User yanks a gem
    ...
    Then I should see "This package has been yanked"
  ...
  Scenario: User who is not owner attempts to yank a gem
    ...
    Then I should see "You do not have permission to yank this package."
  ...
  Scenario: User unyanks a gem
    ...
    And I go to the dashboard
    And I follow "RGem"
    Then I should not see "This package has been yanked."
