Feature: Push Gems
  ...
  Should be able to push gems up to Gemcutter
    ...
    Scenario: User pushes existing version of existing gem
      ...
      Then I should see "Repushing of package versions is not allowed."
      And I should see "Please use `bpm yank` to remove bad releases."
      And I visit the gem page for "PGem"
    ...
    Scenario: User pushes gem with bad name
      Given I am signed up and confirmed as "email@person.com/password"
      And I have an api key for "email@person.com/password"
      And I have a bad gem "123" with version "1.0.0"
      When I push the gem "123-1.0.0.gem" with my api key
